package com.gmail.cactuscata.mq.api;
...
public class ScoreboardSign {
	...
	/**
	 * Create a scoreboard sign for a given player and using a specifig
	 * objective name
	 * 
	 * @param player
	 *            the player viewing the scoreboard sign
	 * @param objectiveName
	 *            the name of the scoreboard sign (displayed at the top of the
	 *            scoreboard)
	 */
	...
	/**
	 * Send the initial creation packets for this scoreboard sign. Must be
	...
	/**
	 * Send the packets to remove this scoreboard sign. A destroyed scoreboard
	 * sign must be recreated using {@link ScoreboardSign#create()} in order to
	 * be used again
	 */
	public void destroy() {
		if (!created)
	 ...
	 * 
	 * @param name
	 *            the name of the objective, max 32 char
	 */
	...
	/**
	 * Change a scoreboard line and send the packets to the player. Can be
	 * called async.
	 * 
	 * @param line
	 *            the number of the line (0 <= line < 15)
	 * @param value
	 *            the new value for the scoreboard line
	 */
	...
	/**
	 * This class is used to manage the content of a line. Advanced users can
	 * use it as they want, but they are encouraged to read and understand the
